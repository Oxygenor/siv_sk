...
// Щоб додати файл: завантажте його в public/documents/ (через веб-інтерфейс GitHub),
// потім додайте до відповідного пункту поле `filename` з точною назвою файлу.
// Поки `filename` не вказано, на сайті показується позначка "документ буде додано найближчим часом".
